...
public class Exam140 {
	...
	public static void main(String[] args) {
		...
		switch (num) {
		case 1:
			System.out.println("s1¹ø ³ª¿È");
			break;
			
		case 2:
			System.out.println("s2¹ø ³ª¿È");
			break;
			
		case 3:
			System.out.println("s3¹ø ³ª¿È");
			break;
			
		case 4:
			System.out.println("s4¹ø ³ª¿È");
			break;
			
		case 5:
			System.out.println("s5¹ø ³ª¿È");
			break;
			
		default:
			System.out.println("s6¹ø ³ª¿È");
			break;
		}
